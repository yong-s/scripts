...
CR6() {
    ql repo https://ghproxy.com/https://github.com/Aaron-lv/sync.git "jd_|jx_|getJDCookie" "activity|backUp|Coupon" "^jd[^_]|USER|utils|sendNotify|JD_" "jd_scripts"
}
CR8() {
...
OR3() {
    ql repo https://ghproxy.com/https://github.com/smiek2121/scripts.git "jd_|gua_" "" "^jd[^_]|USER|utils|sendNotify|ZooFaker|JDJRValidator_|^sign|cleancart_"
}
OR4() {
...
OR12() {
    ql repo https://ghproxy.com/https://github.com/Zy143L/wskey.git "wskey"
}
OR13() {
